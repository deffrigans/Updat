...
tos = ['Hei, jaga mulutmu','Tidak pernah diajari berbicara?','Berhentilah menjadi  Toxic temanku🤢','Jangan menjadi Toxic🦄']
sin =  tos[Math.floor(Math.random() * (tos.length))]
reply(sin)
if (m.text) {
bvl = `\`\`\`「 Toxic Terdeteksi \`\`\`\n\nAnda menggunakan kata-kata yang buruk tetapi Anda adalah seorang admin itu sebabnya saya tidak akan menendang Anda😇`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
title:"Click Here And Follow My Instagram",
...
XeonBotInc.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
    ...
    "drop only emote setiap kali anda mengetik di gc/pc selama 1 hari.",
    ...
    "Biarkan kelompok memilih kata dan lagu yang terkenal. Anda harus menyanyikan lagu itu dan mengirimkannya dalam voice note",
    ...
    "ubah nama menjadi I AM GAY selama 5 jam", "chat ke kontak mana saja di whatsapp dan katakan saya akan menjadi bf/gf Anda selama 5 jam",
    ...
    "buat video tantangan tarian tiktok apa saja dan letakkan di status, Anda dapat menghapusnya setelah 5 jam",
    "putus dengan sahabatmu selama 5 jam tanpa memberitahunya bahwa itu suatu tantangan",
     ...
     "katakan saya suka deepak kalal melalui catatan suara", "tulis saya merasa terangsang dan letakkan di status, Anda dapat menghapusnya hanya setelah 5 jam",
     "tulis saya lesbian dan letakkan di status, Anda dapat menghapus hanya setelah 5 jam",
     ...
     "kirim kata-kata kasar di grup mana pun, terima grup ini, dan kirim bukti tangkapan layar di sini"
              ...
              XeonBotInc.sendMessage(from, { image: buffer, caption: '_*You choose DARE*_\n\n'+ xeondare }, {quoted:fkontak})
              break
                            break
       case 'truth':
              ...
              const truth =[
    "Pernahkah kamu menyukai seseorang? Berapa lama?", "Jika Anda bisa atau jika Anda mau, dengan gc/outside gc, dengan siapa Anda akan berteman? (mungkin berbeda/tipe yang sama)", "apa jaringan terbesar Anda?", "Pernahkah Anda menyukai cinta bertepuk sebelah tangan? jika demikian siapa? gimana rasanya gan?", 
    ...
    "apakah Anda pernah mencuri hal besar dalam hidup Anda? alasan mengapa?",
    "Sebutkan kejadian yang membuatmu terluka yang masih kamu ingat",
    "Prestasi apa yang kamu dapatkan tahun ini?",
    "apa kebiasaan terburukmu di sekolah?",
    ...
    "Siapa naksir selebriti Anda",
    "Mimpi teraneh apa yang pernah kamu alami",
    "Apakah Anda bermain pubg, jika Anda kemudian mengirim nomor id Anda?"
]
              const xeontruth = truth[Math.floor(Math.random() * truth.length)]
              buffer = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
              XeonBotInc.sendMessage(from, { image: buffer, caption: '_*You choose TRUTH*_\n\n'+ xeontruth }, {quoted:fkontak})
              break
...
case 'kapankah':
				...
				if (!text) return replay(`Use Text, Example : ${prefix + command} apakah saya akan menikah? `)
					const kapan = ['5 Lebih Banyak Hari', '10 Hari Lagi', '15 Hari Lagi','20 Hari Lagi', '25 Hari Lagi','30 Hari Lagi','35 Hari Lagi','40 Hari Lagi','45 Hari Lagi ','50 Hari Lagi','55 Hari Lagi','60 Hari Lagi','65 Hari Lagi','70 hari lagi 100 Hari Lagi','5 Bulan Lagi', '10 Bulan Lagi', '15 Bulan Lagi','20 Bulan Lagi', '25 Bulan Lagi','30 Bulan Lagi','35 Bulan Lagi','40 Bulan Lagi','45 Bulan Lagi','50 Bulan Lagi','55 Bulan Lagi','60 Bulan Lagi','65 Bulan Lagi','70 Bulan Lagi','75 Bulan Lagi','80 Bulan Lagi','85 Bulan Lagi','90 Bulan Lagi','100 Bulan Lagi','1 Tahun Lagi','2 Tahun Lagi','3 Tahun Lagi','4 Tahun Lagi','5 Tahun Lagi','Besok','Lusa']
...
case 'wangy':
              ...
              qq = q.toUpperCase()
              awikwok = `${qq} ${qq} ${qq} ❤️ ❤️ ❤️ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, aaah bau rambut ${qq} bau aku ingin mencium wanginya ${qq} AAAAAAAAH ~ Rambutnya.... aaah aku juga ingin membelai rambutnya ~~ AAAAAH ${qq} pertama kali keluar di anime juga lucu ❤️ ❤️ ❤️ jadi AAAAAAAH ${qq} AAAAAA LUCCUUUUUUUUUUUUU............ ${qq} AAAAAAAAAAAAAAAAAAAAGH ❤️ ❤️ ❤️apa ? ${qq} itu tidak nyata ? Hanya NERAKA katamu? tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak, tidak!! SAYA TIDAK PEDULI DENGAN KENYATAANNYA, SAYA TIDAK PEDULI. ❤️ ❤️ ❤️ ${qq} saya ... ${qq} di laptop mengawasi saya, ${qq} .. Anda percaya pada saya ? aaaaaaaaaaah terima kasih ${q} Saya tidak mau menyerah ${qq} aaaaaah ❤️ ❤️ ❤️ YEAAAAAAAAAAAH SAYA MASIH PUNYA ${qq} JUGA TIDAK SAMA AAAAAAAAAAAAAAH`
             reply(awikwok)
              break
              case 'dimanakah':
				...
				if (!text) return replay(`Use Text, Example : ${prefix + command} will i get married `)
					const kapan6 = ['In the samudra', 'Di mars', 'Saya tidak tahu, tanya ayahmu', 'Mungkin di suatu tempat di bumi', 'Saya tidak tahu']
					const kapankah6 = kapan6[Math.floor(Math.random() * kapan6.length)]
XeonBotInc.sendMessage(from, { text: `Question : dimanakah ${q}\nAnswer : *${kapankah6}*` }, { quoted: m })
					break
case 'gsmarena': {
...
╠ ${prefix}request
╠ ${prefix}report [bug]
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"callButton": {"displayText": "Contact Owner","phoneNumber": `+62 895-0996-0601`}},{"urlButton": {"displayText": "INSTAGRAM","url": `https://instagram.com/b4c00t.dtz`}},{"quickReplyButton": {"displayText": "Script","id": 'script'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'ownermenu':
